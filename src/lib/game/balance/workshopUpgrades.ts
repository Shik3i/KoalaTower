...
export const WORKSHOP_UPGRADES: WorkshopUpgrade[] = [
	...
	},
	{
		...
		level: 0,
		maxLevel: 80,
		cost: (level: number) => defaultCost(level, 60, 1.38),
		icon: '🔥',
	},
	{
		...
		level: 0,
		maxLevel: 60,
		cost: (level: number) => defaultCost(level, 70, 1.4),
		icon: '🎯',
	},
	{
		...
		level: 0,
		maxLevel: 80,
		cost: (level: number) => defaultCost(level, 40, 1.32),
		icon: '❤️',
	},
	{
		...
		level: 0,
		maxLevel: 60,
		cost: (level: number) => defaultCost(level, 100, 1.45),
		icon: '🪙',
	},
	{
		...
		level: 0,
		maxLevel: 60,
		cost: (level: number) => defaultCost(level, 80, 1.42),
		icon: '💰',
	},
	{
		...
		level: 0,
		maxLevel: 50,
		cost: (level: number) => defaultCost(level, 90, 1.44),
		icon: '⭐',
	},
	{
